...
// lib/GNSPS/solidity-bytes-utils@0.8.0/contracts/BytesLib.sol
...
// lib/OpenZeppelin/openzeppelin-contracts@4.8.3/contracts/utils/math/Math.sol
...
// lib/OpenZeppelin/openzeppelin-contracts@4.8.3/contracts/utils/Strings.sol
...
// lib/OpenZeppelin/openzeppelin-contracts@4.8.3/contracts/utils/cryptography/ECDSA.sol
...
contract DirectStaking is Initializable, PausableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public tips; // the tips for each stake
     ...
     */
    function getValidatorInfo(uint256 idx)
        external
        view
     ...
     */
    function getValidatorInfos(uint256 from, uint256 to)
        external
        view
        returns (bytes[] memory pubkeys, address[] memory claimAddresses, uint256[] memory extraDatas)
    {
     ...
     */
    function _deposit(bytes calldata pubkey, bytes calldata signature, bytes32 withdrawal_credential, uint256 amount)
        internal
    {
